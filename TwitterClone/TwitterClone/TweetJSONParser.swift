      ...
      for tweetObject in rootObject {
        if let text = tweetObject["text"] as? String,
          ...
          profileImageURL = userInfo["profile_image_url"] as? String {
            ...
            var tweet = Tweet(text: text, username: username, id: id, profileImageURL: biggerProfilePicture, originalTweet: nil, originalUsername: nil, profileImage: nil, originalQuotedTweet: nil, originalQuotedUsername: nil, backgroundImageURL: nil, backgroundImage : nil, location: nil, screenname: nil)
            ...
            if let quotedTweet = tweetObject["quoted_status"] as? [String : AnyObject],
              ...
              originalQuotedUsername = originalQuotedUserInfo["name"] as? String {
                let tweet = Tweet(text: text, username: username, id: id, profileImageURL: biggerProfilePicture, originalTweet: nil, originalUsername: nil, profileImage: nil, originalQuotedTweet: originalQuotedTweet, originalQuotedUsername: originalQuotedUsername, backgroundImageURL: nil, backgroundImage : nil, location: nil, screenname: nil)
                tweets.append(tweet)
              ...
              if let retweet = tweetObject["retweeted_status"] as? [String : AnyObject],
                ...
                originalUsername = originalUserInfo["name"] as? String {
                  ...
                  let tweet = Tweet(text: text, username: username, id: id, profileImageURL: biggerProfilePicture, originalTweet: originalTweet, originalUsername: originalUsername, profileImage: nil, originalQuotedTweet: nil, originalQuotedUsername: nil, backgroundImageURL: nil, backgroundImage : nil, location: nil, screenname: nil)
                  tweets.append(tweet)
              } else {
                tweets.append(tweet)
              }
